<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @endif
             @if (auth()->user()->hasPermission('read_externals'))
             <li><a href="{{ route('dashboard.external.index') }}"><i class="fa fa-th"></i><spa>المنفذ الخارجى</span></a></li>
            @endif
              @if (auth()->user()->hasPermission('read_offecs'))
             <li><a href="{{ route('dashboard.offecs.index') }}"><i class="fa fa-book"></i><spa>مكاتب المعقبين</span></a></li>
            @endif
