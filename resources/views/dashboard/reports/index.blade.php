                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.reports.index') }}" method="get" class="hidden-print">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="date" name="start" class="form-control" placeholder="@lang('site.search')" value="{{ request()->search }}">
                            </div>
                            <div class="col-md-2">
                                <input type="date" name="end" class="form-control" placeholder="@lang('site.search')" value="{{ request()->search }}">
                            </div>
                            <div class="col-md-2">
