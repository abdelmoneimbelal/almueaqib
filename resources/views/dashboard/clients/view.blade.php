                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">@lang('site.name')</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">@lang('site.ardy')</label>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {{--<img style="width: 100px;  height:100px;" class="profile-user-img img-responsive " src="{{asset($users->image_scan)}}"--}}
                                                 {{--alt="scan picture">.--}}

                                                <img src="{{ asset('uploads/img_scan/'.$client->image_scan) }}"  style="width: 100px" class="img-thumbnail img-responsive image-preview" alt="">
                                        </div> -->
                                    </div>
