                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($clients as $index=>$client)
                                <tr>
                                    ...
                                    <td>{{ implode($client->ardy, '-') }}</td>

                                   
                                    <td>{{ $client->address }}</td>
                                    <td><a href="{{ route('dashboard.orders.index', ['client_id' => $client->id]) }}" class="btn btn-info btn-sm">المعاملات المرتبطة</a></td>

                                    <td>
                                    <a href="{{ route('dashboard.clients.show', $client->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> @lang('site.view')</a>
